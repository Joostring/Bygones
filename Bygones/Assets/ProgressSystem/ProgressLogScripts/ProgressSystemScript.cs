...
//    public GameObject progressSystemObject;
...
public class ProgressSystem : MonoBehaviour
{
    ...
    public void ToggleProgressViewUI()
    {
        if (progressSystemObject == null) // Använd det omdöpta fältet
        {
            return;
        }
        ...
        isVisible = !isVisible;
        progressSystemObject.SetActive(isVisible); // Använd det omdöpta fältet
        if (isVisible)
        {
            UpdateProgressText();
        }
    ...
    public void HideProgressView()
    {
        if (progressSystemObject != null) // Använd det omdöpta fältet
        {
            progressSystemObject.SetActive(false); // Använd det omdöpta fältet
            isVisible = false;
        }
    }
    public void AddNote(string newNote)
