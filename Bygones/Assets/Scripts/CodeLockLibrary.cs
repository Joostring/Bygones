...
public class CodelockLibrary : MonoBehaviour
{
    ...
    [SerializeField] private string correctCode = "279";
    [SerializeField] private GameObject olliesKey;
